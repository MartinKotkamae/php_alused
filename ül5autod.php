...
echo "Autode listi pikkus: ",count($autod),"<br>";
echo "Vin koodide listi pikkus: ",count($vin_koodid),"<br>";

$valjastaauto = array_count_values($autod);
echo "Audide arv: ",$valjastaauto["Audi"],"<br>";
echo "Toyotade arv: ",$valjastaauto["Toyota"],"<br>";

foreach ($vin_koodid as $vinkod) {
    if (strlen($vinkod) < 17) {
        echo $vinkod," Pikkus: ",strlen($vinkod),"<br>";
    }
}
?>
